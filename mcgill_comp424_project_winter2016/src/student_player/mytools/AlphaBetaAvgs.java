...
public class AlphaBetaAvgs implements Callable<HusMove> {
	...
	private float alphabeta(final HusBoardState state, Node parent, int depth, float alpha, float beta, boolean isMax) throws Exception{
		...
		if (isInterrupted) throw new Exception("Custom Timeout");
